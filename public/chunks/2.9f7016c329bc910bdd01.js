...
/***/ "./node_modules/babel-loader/lib/index.js?{\"cacheDirectory\":true,\"presets\":[[\"env\",{\"modules\":false,\"targets\":{\"browsers\":[\"> 2%\"],\"uglify\":true}}],\"env\"],\"plugins\":[\"transform-object-rest-spread\",[\"transform-runtime\",{\"polyfill\":false,\"helpers\":false}],\"transform-vue-jsx\",\"syntax-dynamic-import\"]}!./node_modules/vue-loader/lib/selector.js?type=script&index=0!./resources/client/assets/js/views/svg-icons/index.vue":
...
var _requireIcons = __webpack_require__("./resources/client/assets/js/views/svg-icons/requireIcons.js");

var _requireIcons2 = _interopRequireDefault(_requireIcons);

var _clipboard = __webpack_require__("./resources/client/assets/js/utils/clipboard.js");
...
exports.default = {
  ...
  data: function data() {
    return {
      iconsMap: _requireIcons2.default
    };
  },
  ...
  methods: {
    ...
    handleClipboard: function handleClipboard(text, event) {
      (0, _clipboard2.default)(text, event);
    }
  }
};
...
function handleClipboard(_text, event) {
  var clipboard = new _clipboard2.default(event.target, {
    text: function text() {
      return _text;
    }
  });
